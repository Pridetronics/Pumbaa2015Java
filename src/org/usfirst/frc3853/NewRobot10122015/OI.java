...
public class OI {
    ...
    public JoystickButton armsClose;
    ...
    public OI() {
        ...
        armsClose = new JoystickButton(joystick2, 1);
        armsClose.whileHeld(new CloseArms());
        armsOpen = new JoystickButton(joystick2, 1);
        armsOpen.whileHeld(new OpenArms());
        liftDown = new JoystickButton(joystick2, 1);
        liftDown.whileHeld(new LiftDownCommand());
        liftUp = new JoystickButton(joystick2, 1);
        ...
        SmartDashboard.putData("LowerAndOpen", new LowerAndOpen());

        SmartDashboard.putData("UpAndClose", new UpAndClose());
